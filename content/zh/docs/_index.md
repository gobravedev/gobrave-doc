...
欢迎查阅 gobrave 文档。这里提供了使用该平台的指南和参考资料。

### 入门指南

- [快速开始](/zh/docs/quick-start) — 本地搭建和运行 gobrave
- [配置说明](/zh/docs/configuration) — 所有配置选项详解
- [系统架构](/zh/docs/architecture) — 系统架构概览
...
- [Swagger 文档](/zh/docs/api) — 交互式 API 文档
